...
/// <summary>
/// Handles a query synchronously, returning a paginated collection of results.
/// </summary>
/// <remarks>
...
public interface IPaginatedQueryHandler<in TQuery, TOutput> where TQuery : BaseQuery where TOutput : QueryOutput
{
    /// <summary>
    ...
    /// <returns>
    /// A <see cref="PaginatedOutput{T}"/> carrying the page of results along with pagination
    /// metadata, success state, messages and any errors produced while handling the query.
    /// </returns>
